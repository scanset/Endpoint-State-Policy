...
//!
//! This module abstracts all the complexity of `compiler`, `agent_core`, and `common`
...
//!
//! ```ignore
//! use contract_kit::agent_core_api::{scan_file, ScanError};
//! use contract_kit::agent_core_api::{CtnStrategyRegistry, CtnStrategy};
//! use std::sync::Arc;
//!
...
use agent_core::resolution::engine::ResolutionEngine;
use agent_core::types::ResolutionContext;
...
// Execution result
pub use agent_core::execution::engine::PolicyExecutionResult as ScanResult;
...
impl From<agent_core::strategies::StrategyError> for ScanError {
    fn from(err: agent_core::strategies::StrategyError) -> Self {
        Self::RegistryError(err.to_string())
    }
}

impl From<agent_core::conversion::ConversionError> for ScanError {
    fn from(err: agent_core::conversion::ConversionError) -> Self {
